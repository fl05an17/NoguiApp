...
import com.android.noguiapp.ActivityRegister
import com.android.noguiapp.MainActivity
...
class IntroActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        btnGetStart.setOnClickListener {
            //open main activity
            val mainActivity = Intent(applicationContext, ActivityRegister::class.java)
            startActivity(mainActivity)
