...
import com.android.noguiapp.IntroScreen.IntroViewPagerAdapter;
import com.android.noguiapp.IntroScreen.ScreenItem;
import com.google.android.material.tabs.TabLayout;

import java.util.ArrayList;
import java.util.List;

public class IntroActivityTEST extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mList.add(new ScreenItem("Title 1",R.drawable.img_intro_1));
        mList.add(new ScreenItem("Title 2",R.drawable.img_intro_2));
        mList.add(new ScreenItem("Title 3",R.drawable.img_intro_3));
